...
static errno_t customCONFsetup()
{
	...
	function_parameter_add_entry(&fps, ".exposuretime", "Exposure Time [milliseconds]",
...
static errno_t compute_function()
{
    ...
    long width_offset = functionparameter_GetParamValue_INT64(&fps, ".width_offset");
    long height_offset = functionparameter_GetParamValue_INT64(&fps, ".height_offset");
